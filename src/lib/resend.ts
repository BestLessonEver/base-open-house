    ...
    html: `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p>Thank you for registering <strong>${studentName}</strong> for the BASE Open House! We're excited to meet your family and introduce you to our string instrument program.</p>
          ...
          <div style="background: #f8f9fa; border-radius: 8px; padding: 20px; margin: 25px 0;">
            ...
            <p style="margin: 8px 0;"><strong>Location:</strong> BLE Studios</p>
          ...
          <ul style="padding-left: 20px;">
            ...
            <li>Learn about violin, viola, and cello programs</li>
          ...
          <div style="background: #0f172a; border-radius: 8px; padding: 20px; margin: 25px 0; text-align: center;">
            <a href="https://maps.google.com/?q=3222+FM+528+Friendswood+TX+77546" style="display: inline-block; background: #d4a574; color: #0f172a; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600;">Get Directions</a>
          </div>
